import{j as t}from"./index-C-e7tUpr.js";function l({label:r,checked:e,onChange:n,description:s}){return t.jsxs("div",{className:"flex items-start gap-3",children:[t.jsx("button",{role:"switch","aria-checked":e,onClick:()=>n(!e),className:`
